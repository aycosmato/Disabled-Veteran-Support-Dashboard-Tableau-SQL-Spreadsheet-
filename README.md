...
<pre>```Veteran-Support-Analytics/ ├── README.md ├── data/ │ ├── raw/ │ └── cleaned/ ├── sql/ │ ├── create_tables.sql │ └── eda_queries.sql ├── tableau/ │ └── dashboards_overview.pdf └── veteran_data_report.pdf ``` </pre>
